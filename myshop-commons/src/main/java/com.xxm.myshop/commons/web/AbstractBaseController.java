package com.xxm.myshop.commons.web;

import com.xxm.myshop.commons.dto.AbstractBaseDomain;
import com.xxm.myshop.commons.dto.AbstractBaseResult;
import com.xxm.myshop.commons.dto.BaseResultFactory;
...
public abstract class AbstractBaseController<T extends AbstractBaseDomain> {
    ...
    // 用于动态获取配置文件的属性值
    private static final String ENVIRONMENT_LOGGING_LEVEL_MY_SHOP = "logging.level.com.xxm.myshop";
